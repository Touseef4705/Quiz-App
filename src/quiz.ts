...
const nextBtn = document.querySelector(".btn") as HTMLButtonElement;
const quiz_question = document.querySelector("#quiz_question") as HTMLHeadingElement;
const questionHtml = document.querySelector(".question") as HTMLHeadingElement;
const previous_btn = document.querySelector(".previous_btn") as HTMLButtonElement;
const quiz_result = document.querySelector("#quiz_result") as HTMLDivElement;
const quiz_container = document.querySelector(".quiz-container") as HTMLDivElement;
...
let quizQuestionsIndex: number = 0;
...
nextBtn.addEventListener("click", () => {
  const selected = document.querySelector(`input[name = question-${quizQuestionsIndex}]:checked`) as HTMLInputElement
